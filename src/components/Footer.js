  ...
  return (
    <footer className="footer bg-white mt-auto py-3">
      <div className="container">
        <ul className="nav justify-content-center">
          <li className="nav-item">
            <a className="footer-nav-link" href="https://github.com/drewjordan414" target="_blank" rel="noopener noreferrer">
              <Github />
            </a>
          </li>
          <li className="nav-item">
            <a className="footer-nav-link" href="mailto:drewjordan404@gmail.com">
              <Envelope />
            </a>
          </li>
          <li className="nav-item">
            <a className="footer-nav-link" href="https://www.linkedin.com/in/drew-jordan-103993221/" target="_blank" rel="noopener noreferrer">
              <Linkedin />
            </a>
          </li>
        </ul>
